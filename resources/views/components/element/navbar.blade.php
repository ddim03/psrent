                ...
                <li>
                    ...
                    @auth
                        <div class="flex items-center space-x-3 md:space-x-0">
                            ...
                            <div class="z-50 hidden max-w-40 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                                id="user-dropdown">
                                <div class="px-4 py-3">
                                    <span
                                        class="block text-sm text-gray-900 dark:text-white truncate">{{ auth()->user()->name }}</span>
                                    <span
